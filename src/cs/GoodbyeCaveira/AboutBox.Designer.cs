...
namespace GoodbyeCaveira
{
	partial class AboutBox
	{
		...
		private void InitializeComponent()
		{
			...
			// labelProductName
			// 
			this.labelProductName.Cursor = System.Windows.Forms.Cursors.Help;
			...
			this.labelProductName.Text = "Product Name 产品名称: GoodbyeCaveria!";
			this.labelProductName.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.labelProductName.MouseHover += new System.EventHandler(this.labelProductName_MouseHover);
			// 
			// labelVersion
			// 
			...
			this.labelVersion.Text = "Version 版本: 0.0.0.0";
			...
			this.labelCopyright.Text = "copyright 版权: Copyright (c) Orange233 2022";
			...
			this.labelAuthor.Location = new System.Drawing.Point(167, 102);
			this.labelAuthor.Margin = new System.Windows.Forms.Padding(7, 0, 4, 0);
			this.labelAuthor.MaximumSize = new System.Drawing.Size(0, 22);
			this.labelAuthor.Name = "labelAuthor";
			this.labelAuthor.Size = new System.Drawing.Size(316, 22);
			this.labelAuthor.TabIndex = 22;
			this.labelAuthor.Text = "Authors 作者: Orange233";
			this.labelAuthor.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			this.labelAuthor.DoubleClick += new System.EventHandler(this.labelAuthor_DoubleClick);
			// 
			// textBoxDescription
			// 
